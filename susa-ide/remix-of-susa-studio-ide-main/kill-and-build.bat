@echo off
echo ========================================
echo SUSA IDE - Kill Processes and Build
echo ========================================
echo.

echo Step 1: Killing any running Electron/Node processes...
...
if errorlevel 1 (
    ...
    echo Please close any running SUSA IDE or Electron apps and try again
    pause
    exit /b 1
)
echo Done!
